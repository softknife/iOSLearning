...
// This is a helper class used by GEHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface GEDataDecompressor : NSObject {
